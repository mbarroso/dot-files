...
alias cd..='cd ..'
alias gsynch='git pl && git pull --force && git mt && git ps && git ps --tags'
...
export PATH=$PATH:/home/dnoseda/dev/labs/other
...
export ftp_proxy=
export https_proxy=
export JAVA_OPTS=" -Dhttp.proxyHost=10.12.0.251 -Dhttp.proxyPort=3129 -Dhttp.proxyUser=guest -Dhttp.proxyPassword=mercadolibre -Dhttp.nonProxyHosts=localhost|10.10.42.47|git.ml.com  -Dwt.headless=true "
